  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">V.S Admin</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-dark py-2 collapse-inner rounded">
            <h6 class="collapse-header">Candidate Form :</h6>
            <a class="collapse-item text-info" href="{{route('candidates.index')}}">Candidates Table</a>
            <a class="collapse-item text-info" href="{{route('candidates.create')}}">Add New Candidate</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseT" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-dark py-2 collapse-inner rounded">
            <h6 class="collapse-header">Package Form :</h6>
            <a class="collapse-item text-info" href="{{route('packages.index')}}">Packages Table</a>
            <a class="collapse-item text-info" href="{{route('packages.create')}}">Add New Package</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Packages -->
      <li class="nav-item">
        <a class="nav-link" href="{{route('votelist')}}">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Vote List</span></a>
      </li>
